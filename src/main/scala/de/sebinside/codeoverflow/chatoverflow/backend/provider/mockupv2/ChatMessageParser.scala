...
/**
  ...
  */
private[mockupv2] trait MockupElement
...
/**
  ...
  */
private[mockupv2] case class ChatElement(user: String, message: String, isPremium: Boolean) extends MockupElement
...
/**
  ...
  */
private[mockupv2] case class DelayElement(delay: Int) extends MockupElement
...
/**
  ...
  */
private[mockupv2] case class RepeatElement(times: Int) extends MockupElement

/**
  * An empty element usually represents an empty line. It is the delimiter of a repetition segment.
  */
private[mockupv2] case class EmptyElement() extends MockupElement
...
/**
  ...
  */
private[mockupv2] class ChatMessageParser(var defaultEscape: String = "!",
